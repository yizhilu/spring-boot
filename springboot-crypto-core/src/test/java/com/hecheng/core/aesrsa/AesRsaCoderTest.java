...
import com.hecheng.core.common.utils.crypto.aesrsa.RSA;
import com.hecheng.core.common.utils.crypto.aesrsa.SecureRandomUtil;
...
public class AesRsaCoderTest {
  ...
  /**
   * 1. 服务器端(server)和客户端(client)分别生成自己的密钥对 2. server和client分别交换自己的公钥
   */
  ...
  public void testSignAndVerify() {
    System.out.println(serverPrivateKey.length());
    System.out.println(clientPrivateKey.length());
  ...
  public void client(HashMap<String, Object> params) throws Exception {
    ...
    System.out.println("3. client生成AES密钥(aesKey) - 随机生成AES密钥: ");
    System.out.println(aesKey);

    // 4. client使用sever的RSA公钥对aesKey进行加密(encryptkey)
    String encryptkey = RSA.encrypt(aesKey, serverPublicKey);
    System.out.println("4. client使用sever的RSA公钥对aesKey进行加密(encryptkey): ");
    ...
    System.out.println("7. client使用aesKey对json数据进行加密得到密文(data): ");
  ...
  public void server() throws Exception {
    ...
    // 1. 对客户端请求的数据，进行验签
    boolean passSign = EncryUtil.checkDecryptAndSign(RequestInfo.data, RequestInfo.encryptkey,
    ...
    if (passSign) {
      ...
      System.out.println("-----------得到最终解密后的明文:" + "sid: " + sid + " orderId: " + orderId
          + " dfMercId: " + dfMercId + " amt: " + amt);
  ...
  public void test() throws Exception {
    ...
    String e =
        "";
    String a =
        "";
    boolean passSign = EncryUtil.checkDecryptAndSign(a, e, serverPublicKey, clientPrivateKey);
    if (passSign) {
      String aeskey = RSA.decrypt(e, clientPrivateKey);
      System.out.println(aeskey);

      String data = AESCoder.decryptFromBase64(a, aeskey);
      System.out.println(data);
    }
