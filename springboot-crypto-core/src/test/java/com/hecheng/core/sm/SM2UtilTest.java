...
import com.hecheng.core.common.utils.crypto.sm.BCECUtil;
import com.hecheng.core.common.utils.crypto.sm.SM2Util;
import com.hecheng.core.sm.utils.FileUtil;
...
public class SM2UtilTest {
  ...
  public void testGenerateKeyPair() {
    ...
    System.out
        .println("Pri Hex:" + ByteUtils.toHexString(priKey.getD().toByteArray()).toUpperCase());
    ...
    /*
     * Pri Hex:315BACF546B53F044AEC2C2F6794A74CF5442A0455ABDDA861F3B9C52DAA0A76 Pub X
     * Hex:F1A3C8FA5CC4183DD113FDB1817EC92C5B5A5C4259A360EACB177A4C85C24BBE Pub X
     * Hex:5FD20DEC765D5CE9C9E477354FB4F5C548C67676F8D684986B7238D2880823BC Pub Point Hex:
     * 04F1A3C8FA5CC4183DD113FDB1817EC92C5B5A5C4259A360EACB177A4C85C24BBE5FD20DEC765D5CE9C9E477354FB4F5C548C67676F8D684986B7238D2880823BC
     */
  }
  ...
  public void testSignAndVerify1() {
    try {
      ...
      // --------------------------------服务端--------------------------------
      // 得到client公钥钥对象
      ECPublicKeyParameters pubKey = BCECUtil.createECPublicKeyParameters(pubxHex, pubyHex,
  ...
  public void testSM2KeyRecovery() {
    try {
      ...
      String encodedPubHex =
          "04FF6712D3A7FC0D1B9E01FF471A87EA87525E47C7775039D19304E554DEFE0913F632025F692776D4C13470ECA36AC85D560E794E1BCCF53D82C015988E0EB956";
      String signHex =
          "30450220213C6CD6EBD6A4D5C2D0AB38E29D441836D1457A8118D34864C247D727831962022100D9248480342AC8513CCDF0F89A2250DC8F6EB4F2471E144E9A812E0AF497F801";
      byte[] signBytes = ByteUtils.fromHexString(signHex);
      byte[] src = ByteUtils
          .fromHexString("0102030405060708010203040506070801020304050607080102030405060708");
  ...
  public void testGenerateBCECKeyPair() {
    try {
      ...
      ECPrivateKeyParameters priKey =
          BCECUtil.convertPrivateKeyToParameters((BCECPrivateKey) keyPair.getPrivate());
      ECPublicKeyParameters pubKey =
          BCECUtil.convertPublicKeyToParameters((BCECPublicKey) keyPair.getPublic());
