 ...
 * 
 */
package com.hecheng.curator.repository.internal;
...
public class RoleDaoImp implements RoleDao {
   ...
   * (non-Javadoc)
   * 
   * @see com.cheshangma.merchant.repository.internal.RoleDao#getByCondition(java.util.Map,
      ...
      public Predicate toPredicate(Root<RoleEntity> root, CriteriaQuery<?> query,
        ...
        if (params.get("statusType") != null) {
          predicates.add(cb.equal(root.get("status").as(StatusType.class),
              (StatusType) params.get("statusType")));
        }
        // 遍历查询条件，查询语句
