...
/**
 * AccessDecisionManager 进行最终的访问控制（授权）决定。 负责鉴定用户是否有访问对应资源（方法或URL）的权限
 * 
 * @author hc
 *
 */
...
public class CustomAccessDecisionManager implements AccessDecisionManager {
  ...
  public void decide(Authentication authentication, Object object,
    ...
    for (GrantedAuthority grantedAuthority : currentAuthors) {
      ...
      if (StringUtils.equals(grantedAuthority.getAuthority(), "CLIENT")||
          StringUtils.equals(grantedAuthority.getAuthority(), "ADMIN")
