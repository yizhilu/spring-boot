package com.hecheng.security.configuration;
...
import com.hecheng.security.configuration.security.UserSecurityDetailsService;
import com.hecheng.security.configuration.security.jwt.JwtAuthenticationEntryPoint;
import com.hecheng.security.configuration.security.jwt.JwtAuthenticationFilter;
import com.hecheng.security.configuration.security.jwt.JwtUserDetailsService;
import com.hecheng.security.configuration.security.jwt.JwtUsernamePasswordAuthenticationFilter;
import com.hecheng.security.configuration.security.jwt.utils.JwtTokenUtil;
...
public class MultiHttpSecurityConfig {
  ...
  public static class RestfulApiWebSecurityConfigurationAdapter
    ...
    protected void configure(HttpSecurity http) throws Exception {
      ...
      http.csrf().disable()
          ...
          .addFilterBefore(
              new JwtAuthenticationFilter(this.userDetailsService(), jwtTokenUtil, tokenHeader),
    ...
    @Bean(value = "jwtDaoAuthenticationProvider")
  ...
  public static class CookieWebSecurityConfigurerAdapter extends WebSecurityConfigurerAdapter {
     ...
     * @return
     */
    @Bean(value = "userSecurityDetailsService")
    public UserDetailsService userDetailsService() {
